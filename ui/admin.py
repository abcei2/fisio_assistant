...
class UserAdmin(admin.ModelAdmin):
    ...
    list_display = ['patient_name','patient_last_name','authorization_time','whatsapp_number','notified', 'authorized','first_join']
        ...
        if not request.user.is_superuser:
            ...
            if len(groups)>0:
                if str(groups[0]) == "specialist":    
                    ...
                    self.fields = ('whatsapp_number','legal_id','first_name', 'last_name','notified', 'authorized','first_join' )
        else: 
